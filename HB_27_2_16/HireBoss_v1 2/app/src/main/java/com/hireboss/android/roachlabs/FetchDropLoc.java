...
public class FetchDropLoc extends AppCompatActivity implements OnMapReadyCallback {
    String url;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fetch_drop_loc);
        next=(Button)findViewById(R.id.nextbutdrop);
       ...
       final String plat=prev.getStringExtra("pickuplat"),plon=prev.getStringExtra("pickuplon");
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(starts.latitude!=0.0 ) {
                    ...
                    editor.putString("droplon",starts.longitude+"");
                    editor.putString("droplat",starts.latitude+"");
                    editor.commit();

                    Intent nexts = new Intent(getApplicationContext(), grocery.class);
    ...
    public void geosuggest(View v) throws IOException
    {
       ...
       // Toast.makeText(this,lat+":"+lon,Toast.LENGTH_LONG).show();
        ...
        CameraPosition cameraPosition=new CameraPosition.Builder()
                ...
                .build();
        mMap.animateCamera(CameraUpdateFactory.newCameraPosition(cameraPosition));
        mMap.addMarker(new MarkerOptions().position(starts).title("DROP"));
